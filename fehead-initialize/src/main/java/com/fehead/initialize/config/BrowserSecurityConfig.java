...
//                .and()
                .formLogin()
                .loginPage("/api/v1.0/sys/login/oauth")
//                .loginProcessingUrl(securityProperties.getBrowser().getFormLoginUrl())
                .loginProcessingUrl("/api/v1.0/sys/login/form")
...
//                .authenticationDetailsSource(authenticationDetailsSource)
                ...
                .antMatchers("/authentication/require",
                        ...
                        "/api/v1.0/user/resetPassword",
                        "/api/v1.0/user/register/**",
                        "/api/v1.0/user/login/email",
                        "/api/v1.0/sys/login/addInfo",
                        "/api/v1.0/user/user",
                        "/email_validate.html",
                        "/api/v1/static/slideShow",
                        "/api/v1.0/SUSTDelivery/view/login").permitAll()
                .antMatchers("/api/v1.0/sys/login/oauth",
                        "/api/v1.0/sys/login/login").permitAll()
                // swagger start
